...
public class ProductService {
    ...
    private void initializeFakeData() {
        ...
        variants.add(new ProductVariant("v1", "1", "Chico", "CAF-AME-CH", 45.0, 15.0, 0.16, true, 100));
        variants.add(new ProductVariant("v2", "1", "Mediano", "CAF-AME-MD", 55.0, 20.0, 0.16, true, 100));
        variants.add(new ProductVariant("v3", "1", "Grande", "CAF-AME-GR", 65.0, 25.0, 0.16, true, 100));
        variants.add(new ProductVariant("v4", "2", "Chico", "CAF-LAT-CH", 55.0, 20.0, 0.16, true, 100));
        variants.add(new ProductVariant("v5", "2", "Mediano", "CAF-LAT-MD", 65.0, 25.0, 0.16, true, 100));
        variants.add(new ProductVariant("v6", "2", "Grande", "CAF-LAT-GR", 75.0, 30.0, 0.16, true, 100));
        variants.add(new ProductVariant("v7", "3", "Chico", "CAF-CAP-CH", 50.0, 18.0, 0.16, true, 100));
        variants.add(new ProductVariant("v8", "3", "Mediano", "CAF-CAP-MD", 60.0, 23.0, 0.16, true, 100));
        variants.add(new ProductVariant("v9", "3", "Grande", "CAF-CAP-GR", 70.0, 28.0, 0.16, true, 100));
        variants.add(new ProductVariant("v19", "7", "Rebanada", "PAS-CHO-REB", 65.0, 25.0, 0.16, true, 24));
    }
}